            ...
            <div className="max-w-lg mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold font-display">Sujata Mastani</h1>
                            <p className="text-xs opacity-80">{username || 'Inventory Manager'}</p>
                        </div>
                    </div>

                    {/* Connection Status */}
                    {!isOnline && (
                        <div className="absolute top-full left-0 right-0 bg-red-600 text-white text-center text-xs py-1">
                    ...
                    {role === 'admin' && Object.keys(stores).length > 0 && (
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-white/20 text-white border border-white/30 rounded-lg px-3 py-2 pr-8 text-sm font-medium backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer"
                            >
